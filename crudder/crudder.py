...
from airbase import tools as at_tools
from airbase.utils import Logger
...
class Crudder:
    ...
    async def get_csv_data(
        ...
        if style:
            df.rename(
                columns=lambda x: Crudder._fmt_col_names(
    ...
    async def crud(data: list, dest: str, **kwargs) -> None:
        ...
        """  # noqa: E501
        if dest == "airtable":
            await Crudder._at_crud(data, **kwargs)
        elif dest == "sheets":
            Crudder._sh_crud(data, **kwargs)
